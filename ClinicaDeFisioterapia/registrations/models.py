...
class RegisterMedico(models.Model):
    ...
    pagMes = models.CharField(default="A pagar", max_length=100)
...
class RegisterPacientes(models.Model):
    ...
    pagMes = models.CharField(max_length=50, default="A pagar")
...
class RegisterAgenda(models.Model):
    ...
    obs_consulta = models.TextField(max_length=3000, default='', null=False, blank=False)
...
class RegisterFinanca(models.Model):
    ...
    despezas = models.DecimalField(max_digits=10, decimal_places=2, default="-")
