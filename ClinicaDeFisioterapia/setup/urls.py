...
urlpatterns = [
    ...
    path("completeM/<int:pk>", RegisterMedicoPago.as_view(), name="medico_pago"),
    ...
    path("completeP/<int:pk>", RegisterPacientesPago.as_view(), name="pagamento_paciente"),
